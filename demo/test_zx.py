...
import tools_matrix_zx as tools
import caffe
import cv2
import numpy as np
import argparse
...
def get_args():
    ...
    parser.add_argument('--input', default='m.jpeg', help='an integer for the accumulator')
    parser.add_argument('--output', default='test.jpg', help='sum the integers (default: find the max)')
